...
```{r STfish, eval=FALSE, include=FALSE}
...
```{r STtable, eval=FALSE, include=FALSE}
#pipe data to table and give caption
STtag6<- STtag6%>%
  flextable() %>%
...
During this report period #r SSshedcount# tags were found shed. 
...
#### *Tags started week 1:* `r wk1` A total of 10 acoustic tags (model SS400) were randomly selected to be used in this tag life study. Tags were started on `r wk1` and placed into the tag life tank for the duration of the study. All tags in the RBDD Week 1 tag life study made it to the warranty life of 71 days and were detected consistently.

#### *Tags started week 2:* `r wk2` A total of 10 acoustic tags (model SS400) were randomly selected to be used in this tag life study. Tags were started on `r wk2` and placed into the tag life tank for the duration of the study. 

#### *Tags started week 3:* `r wk3` A total of 10 acoustic tags (model SS400) were randomly selected to be used in this tag life study. Tags were started on `r wk3` and placed into the tag life tank for the duration of the study. 

#### *Tags started week 4:* #r wk4# A total of 10 acoustic tags (model SS400) were randomly selected to be used in this tag life study. Tags were started on #r wk4# and placed into the tag life tank for the duration of the study. 
